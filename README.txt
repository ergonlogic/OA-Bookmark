...
<pre>
javascript:u=document.location.href;t=document.title;s=window.getSelection();void(window.open(%22http://PUT-YOUR-OWN-DOMAIN.COM/node/add/el-oa-bookmark?edit[title]=%22+escape(t)+'&edit[field_el_oa_bookmark_body][0][value]='+escape(s)+'&edit[field_el_oa_bookmark_url][0][url]='+escape(u),'_blank','width=1024,height=500,status=yes,resizable=yes,scrollbars=yes'));
</pre>
